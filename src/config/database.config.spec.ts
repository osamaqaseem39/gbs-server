...
describe('Database Configuration', () => {
  ...
  beforeEach(() => {
    configService = {
      get: jest.fn((key: string) => {
        const config = {
          'database.uri': 'mongodb+srv://STATIONERY:STATIONERY@cluster0.9h2ub5o.mongodb.net/test?retryWrites=true&w=majority&appName=Cluster0',
  ...
  it('should return valid Mongoose configuration', () => {
    ...
    expect(config.uri).toBe('mongodb+srv://STATIONERY:STATIONERY@cluster0.9h2ub5o.mongodb.net/test?retryWrites=true&w=majority&appName=Cluster0');
